...
$(function()
        ...
        $('a').click(function(){
            $.get($(this).attr('title'),function(jdata){
                if(jdata.status == 1 )
                alert(JSON.stringify(jdata.content));
                });
            });
        //alert('ss');
...
//            {
//            //alert('2');
//            $.get('/index.php/Home/Ajax/getProduct',function(jdata){
//                //alert(data);
//                if(jdata.status == 1 )
//                alert(JSON.stringify(jdata.content));
...
<div id="panelwrap">
    ...
    <div class="menu">
    <ul>
    <li><a href="#" class="selected">版本发布</a></li>
    <li><a href="#">软件下载</a></li>
...
<table id="rounded-corner">
    ...
    <h2>Browse categories</h2>
        ...
        <ul>
            <?php if(is_array($proitems)): foreach($proitems as $key=>$vo): ?><li><a href="#" title="/index.php/Home/Ajax/getPrjId/id/<?php echo ($vo["id"]); ?>" class="selected"><?php echo ($vo["typename"]); ?></a></li><?php endforeach; endif; ?>
